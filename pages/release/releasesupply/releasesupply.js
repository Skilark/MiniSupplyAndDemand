// pages/release/releasesupply/releasesupply.js
Page({
  ...
  data: {
    ...
    index3:0,
    index4:0,
    qualityArray: ['2成新', '4成新', '6成新','8成新','全新'],
    typeArray:['复习资料','教辅教材','电器','其他'],
  ...
  bindQualityChange: function(e){
    console.log('qualityPicker发送选择改变，携带值为', e.detail.value)
    this.setData({
